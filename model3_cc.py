...
def batch(a,w,TminA,TmaxA, TminL,TmaxL,export_fns):
    ...
    ToptA_mid = (TminA + TmaxL)/2
    ToptA_mor1 = ToptA_mid - 7.5
    ToptA_mor2 = ToptA_mid + 7.5
    v_maxA = 0.25
    v_minA = 0.05
    ...
    ToptL_mor1 = ToptL_mid - 7.5
    ToptL_mor2 = ToptL_mid + 7.5
    # egg
    v_min_egg = 0.02
    v_max_egg = 0.15
    ...
    A_add = 10000000
    L_add = 50000
    if Temp_max <= 10 or Temp_min >= 35:
        ts = np.arange(0,365*30,0.01)
        n_t=len(ts)
        ...
        def year_loop(A_add,L_add):
            ...
            ov_mor = 0.7
            A_surv = A_end*ov_mor;L_surv = L_end*ov_mor
    ...
    draw_multi_lines(Adens_p,'Ap',plotAp_folder,a,w,Tmin = TminA,Tmax = TmaxA,xlabel = 'Day', ylabel = 'Aphid Population Abundance')
    draw_multi_lines(Ldens_p,'L',plotL_folder,a,w,Tmin = TminL,Tmax = TmaxL,xlabel = 'Day', ylabel = 'Ladybird Population Abundance')        
